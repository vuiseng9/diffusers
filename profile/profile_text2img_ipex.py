...
pipe = StableDiffusionPipeline.from_pretrained("runwayml/stable-diffusion-v1-5", scheduler=dpm, torch_dtype=torch.bfloat16)
...
sample = torch.randn(2,4,64,64, dtype=torch.bfloat16)
timestep = torch.rand(1, dtype=torch.bfloat16)*999
encoder_hidden_status = torch.randn(2,77,768, dtype=torch.bfloat16)
